        ...
        <div className="bg-white border rounded-lg shadow-sm p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              we obtain from third-party services when you sign in:
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                  <li>
                    Name and email address from your Google or Strava account
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                  ...
                  <li>
                    Component details (parts, manufacturers, installation dates)
                  </li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li>
                ...
                services that help us operate our application (hosting,
                analytics, etc.)
              </li>
              <li>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-700">
                  For authentication and account creation. Subject to Google's
                  Privacy Policy.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700">
                  For authentication and potential activity integration. Subject
                  to Strava's Privacy Policy.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700">
                  For image storage and processing. Images are stored securely
                  and only accessible through our application.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-900">Hasura</h3>
                <p className="text-gray-700">
                  For database management and GraphQL API. All data is encrypted
                  and stored securely.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              of data in transit and at rest, regular security assessments, and
              access controls.
            </p>
          </section>
