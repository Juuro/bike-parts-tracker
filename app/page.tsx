        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Keep track of all your bike components, maintenance schedules, and upgrades. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">Keep detailed records of all your bicycles and their specifications.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="text-3xl mb-4">🔧</div>
              <h3 className="text-lg font-semibold mb-2">Track Components</h3>
              <p className="text-gray-600">Monitor every part, from wheels to drivetrains, with detailed information.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="text-3xl mb-4">📊</div>
              <h3 className="text-lg font-semibold mb-2">Maintenance History</h3>
              <p className="text-gray-600">Keep track of when parts were installed, replaced, or serviced.</p>
            </div>
          </div>
